...
all: results/val_score_results.csv results/models/final_svc.pkl results/counts_categorical_by_target.png results/cm.png results/pr_curve.png results/roc_curve.png doc/contraceptive_method_predictor_report.html doc/contraceptive_method_predictor_report.md
...
# pre-process data and tune model (here, find K for k-nn using 30 fold cv with Cohen's Kappa)
...
# render report
doc/contraceptive_method_predictor_report.html doc/contraceptive_method_predictor_report.md: doc/contraceptive_method_predictor_report.Rmd doc/cmp_refs.bib doc/01_Summary.Rmd doc/02_Intro.Rmd doc/03_Data.Rmd doc/04_EDA.Rmd doc/05_Method.Rmd doc/06_Results.Rmd doc/07_Acknowledgment.Rmd
