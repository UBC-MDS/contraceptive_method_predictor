...
We will study the confusion matrix to understand the model's predictive power from the figure \@ref(fig:confusionmat):
...
To understand the precision and recall trade off our model we plotted the PR curve with the mean Average Precision score. We observed a good enough AP score of 0.79 from the figure \@ref(fig:precrec).
...
In order to get an overall score for our model . We observe the Area under the curve which gives us a decent score of 78% from the figure \@ref(fig:roccurve).
