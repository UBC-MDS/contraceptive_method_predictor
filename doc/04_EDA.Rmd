...
From the Figure \@ref(fig:histTarget) For simplicity reasons we have combined the use of contraceptive into one group and no use of contraceptive into another. This way, it becomes a binary classification problem, on which we have build our predictive model.
...
It is found that most of the observation by target class 1 (no contraception) lies on certain categorical variables from the figure \@ref(fig:countCatByTarget). 
