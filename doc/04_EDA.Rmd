...
First, it is important to understand the atributes of the dataset. We performed exploratory data analysis on the training dataset and we found no missing values. The attributes of the training dataset are outlined below
